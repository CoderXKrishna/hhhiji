...
$botToken = "6495929445:AAEWxF9x_82AEgv9-qhMoqpEMqJymnz63SE";
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "Owner 🧑‍💻", 'url' => "https://t.me/Mr_Mrs_Krishna"],
            ['text' => "BUY 💰", 'url' => "https://t.me/Itsz_Krish_Babess"],
        ],
    ]
]);
...
if ($cdata2 == "price") {
    ...
    $priceKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => '𝑯𝑶𝑴𝑬', 'callback_data' => 'back2'], ['text' => '𝑩𝑼𝒀', 'url' => 'https://t.me/Carding_Chronicle']]
        ]
    ]);
